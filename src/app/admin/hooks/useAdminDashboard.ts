...
- **إجباري جداً:** اذكر اسم المتجر "The VitaHub" في نهاية العنوان (title) وفي وصف الميتا (seoDesc) لتعزيز العلامة التجارية.
قم بإرجاع كائن JSON فقط بالهيكل التالي بدقة ودون أي كلام خارجي على الإطلاق:
{
  "title": "عنوان SEO قوي ومقروء، يبدأ باسم المنتج أو المادة الفعالة، وينتهي دائماً باسم المتجر (The VitaHub)",
